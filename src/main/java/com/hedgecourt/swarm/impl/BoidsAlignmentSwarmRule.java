...
public class BoidsAlignmentSwarmRule extends AbstractSwarmRule implements SwarmRule {

	public BoidsAlignmentSwarmRule() {
		super();
	}
	...
	public DesiredVelocity getDesiredVelocity(Speck s, List<Speck> neighbors) {
		...
		if (s.type() != Speck.TYPE_PREY || neighbors.size() == 1) {
			...
			dVel.setWeight(SwarmConfig.RULE_WEIGHT_ALIGNMENT);
		}
